/*
  Wrap the code you've written in a function called loopy(range, multiples, words)
  ...
  The loopy function should log to the console all the numbers
  from 15 to 90, except replacing multiples of 2 with "Batty",
...
function loopy(range, multiples, words) {
  for (let i = range[0]; i <= range[1]; i++) {
    ...
    ((i % multiples[0] == 0) && (i % multiples[1] == 0)) && console.log(words[1]+words[1]);
  }
}
